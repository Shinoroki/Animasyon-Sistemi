...
function ani_start()
	ani_window = guiCreateWindow(0.8,0.30,0.20,0.40,"Animasyonlar",true)
		guiWindowSetSizable(ani_window,false)

	ani_tab_panel = guiCreateTabPanel(0.05, 0.07, 0.90, 0.90, true, ani_window)

	ani_tab_all = guiCreateTab("Tümü", ani_tab_panel)
		...
		ani_loop = guiCreateCheckBox(0.10,0.83,0.45,0.08,"Tekrarla",true,true,ani_tab_all)

		ani_button = guiCreateButton(0.10,0.92,0.25,0.06, "Başlat",true,ani_tab_all)
			addEventHandler("onClientGUIClick", ani_button, ani_animation, false)
			
		ani_add_favourites = guiCreateButton(0.40,0.92,0.25,0.06, "Ekle",true,ani_tab_all)
			addEventHandler("onClientGUIClick", ani_add_favourites, ani_add, false)
		
		ani_close = guiCreateButton(0.70,0.92,0.25,0.06,"Kapat",true,ani_tab_all)
	...
	ani_tab_favourites = guiCreateTab("Favourites", ani_tab_panel)
		...
		ani_loop_fav = guiCreateCheckBox(0.10,0.83,0.45,0.08,"Tekrarla",true,true,ani_tab_favourites)

		ani_button_fav = guiCreateButton(0.10,0.92,0.25,0.06, "Başlat",true,ani_tab_favourites)
			addEventHandler("onClientGUIClick", ani_button_fav, ani_animation, false)
			
		ani_add_favourites_fav = guiCreateButton(0.40,0.92,0.25,0.06, "Sil",true,ani_tab_favourites)
			addEventHandler("onClientGUIClick", ani_add_favourites_fav, ani_del, false)
		
		ani_close_fav = guiCreateButton(0.70,0.92,0.25,0.06,"Kapat",true,ani_tab_favourites)
