...
function bar3Animation(thePlayer, cmd, arg)
	local logged = getElementData(thePlayer, "loggedin")

	if (logged==1) then
		exports.global:applyAnimation( thePlayer, "BAR", "BARman_idle", -1, false, false, false)
	end
end
addCommandHandler ( "lean 2", bar3Animation, false, false )
...
addCommandHandler ( "lean2", bar3Animation, false, false )
